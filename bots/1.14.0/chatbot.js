...
export default class Chatbot {
  ...
  injectStyles() {
    ...
    const styles = `
          ...
          /* Common Inputs - Persistent buttons above input */
          ...
          .common-inputs-container::-webkit-scrollbar {
            height: 4px;
          }
          .common-inputs-container::-webkit-scrollbar-track {
            background: transparent;
          }
          .common-inputs-container::-webkit-scrollbar-thumb {
